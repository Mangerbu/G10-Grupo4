...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registro.add(new Registro(1L, "Manuel Lopez", 175L, 75L, 24L));
        registro.add(new Registro(2L, "Samuel Martinez", 178L, 79L, 24L));
        registro.add(new Registro(3L, "Antonio Sierra", 158L, 80L, 32L));
        registro.add(new Registro(4L, "Laura Camargo", 180L, 50L, 15L));
        registro.add(new Registro(5L, "Lucia Torres", 150L, 50L, 22L));
        registro.add(new Registro(6L, "Andrea Uribe", 165L, 59L, 21L));
        registro.add(new Registro(7L, "Carlos Blanco", 190L, 90L, 24L));
        registro.add(new Registro(8L, "Andres Gomez", 200L, 95L, 23L));
        registro.add(new Registro(9L, "Rocio Marin", 155L, 50L, 20L));
